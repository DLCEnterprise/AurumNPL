...
const DEMO_LISTINGS = [
  // ── Residential SENIOR (avgDelinquency in MONTHS) ──────────────────────
  { n: 1,  sellerIdx: 0, title: 'Dallas Metro Single-Family NPL Pool (12 Notes)',     assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 12, unpaidBalance: 2_350_000, askingPrice: 1_540_000, location: 'Dallas, TX',      state: 'TX', zip: '75201', avgDelinquency: 11, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 2,  sellerIdx: 0, title: 'Atlanta SFR Senior-Lien Tape — 8 Loans',             assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 8,  unpaidBalance: 1_780_000, askingPrice: 1_140_000, location: 'Atlanta, GA',     state: 'GA', zip: '30303', avgDelinquency:  8, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 3,  sellerIdx: 1, title: 'Phoenix Valley Residential Note (Single Asset)',     assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 1,  unpaidBalance: 412_000,   askingPrice: 268_000,   location: 'Phoenix, AZ',     state: 'AZ', zip: '85003', avgDelinquency:  6, performanceStatus: 'Sub-Performing', ndaRequired: false, status: 'ACTIVE' },
  { n: 4,  sellerIdx: 1, title: 'Jacksonville FL — 5 NPL Senior Liens',               assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 5,  unpaidBalance: 945_000,   askingPrice: 620_000,   location: 'Jacksonville, FL', state: 'FL', zip: '32202', avgDelinquency: 14, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 5,  sellerIdx: 2, title: 'Cleveland OH Re-Performing Pool — 20 Notes',         assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 20, unpaidBalance: 1_220_000, askingPrice: 880_000,   location: 'Cleveland, OH',   state: 'OH', zip: '44113', avgDelinquency:  3, performanceStatus: 'Re-Performing',  ndaRequired: true,  status: 'ACTIVE' },
  { n: 6,  sellerIdx: 2, title: 'Detroit MI Tape — Mixed Status Single-Family',       assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 15, unpaidBalance: 1_055_000, askingPrice: 615_000,   location: 'Detroit, MI',     state: 'MI', zip: '48201', avgDelinquency:  9, performanceStatus: 'Non-Performing', ndaRequired: false, status: 'ACTIVE' },
  { n: 7,  sellerIdx: 0, title: 'Charlotte Metro Residential Note',                   assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 1,  unpaidBalance: 365_000,   askingPrice: 245_000,   location: 'Charlotte, NC',   state: 'NC', zip: '28202', avgDelinquency:  7, performanceStatus: 'Non-Performing', ndaRequired: false, status: 'ACTIVE' },
  { n: 8,  sellerIdx: 6, title: 'Tampa Bay 4-Loan Senior Bundle',                     assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 4,  unpaidBalance: 845_000,   askingPrice: 595_000,   location: 'Tampa, FL',       state: 'FL', zip: '33602', avgDelinquency:  5, performanceStatus: 'Sub-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 9,  sellerIdx: 1, title: 'Memphis TN Residential NPL — 7 Notes',               assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 7,  unpaidBalance: 638_000,   askingPrice: 410_000,   location: 'Memphis, TN',     state: 'TN', zip: '38103', avgDelinquency: 12, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 10, sellerIdx: 2, title: 'Las Vegas NV Single-Asset Senior Lien',              assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 1,  unpaidBalance: 528_000,   askingPrice: 340_000,   location: 'Las Vegas, NV',   state: 'NV', zip: '89101', avgDelinquency:  7, performanceStatus: 'Non-Performing', ndaRequired: false, status: 'ACTIVE' },

  // ── Residential JUNIOR / HELOC ────────────────────────────────────────
  { n: 11, sellerIdx: 0, title: 'Multi-State Junior Lien Bundle — 18 HELOCs',         assetType: 'RESIDENTIAL', lienPosition: 'JUNIOR', loanCount: 18, unpaidBalance: 612_000,   askingPrice: 188_000,   location: 'Various',         state: 'CA', zip: '90001', avgDelinquency:  9, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 12, sellerIdx: 1, title: 'California 2nd-Lien Pool — 6 Loans',                 assetType: 'RESIDENTIAL', lienPosition: 'JUNIOR', loanCount: 6,  unpaidBalance: 295_000,   askingPrice: 92_000,    location: 'Los Angeles, CA', state: 'CA', zip: '90015', avgDelinquency:  7, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 13, sellerIdx: 2, title: 'Texas Junior Lien NPL — 9 Notes',                    assetType: 'RESIDENTIAL', lienPosition: 'JUNIOR', loanCount: 9,  unpaidBalance: 388_000,   askingPrice: 118_000,   location: 'Houston, TX',     state: 'TX', zip: '77002', avgDelinquency: 14, performanceStatus: 'Non-Performing', ndaRequired: false, status: 'ACTIVE' },
  { n: 14, sellerIdx: 6, title: 'New Jersey HELOC NPL Single Asset',                  assetType: 'RESIDENTIAL', lienPosition: 'JUNIOR', loanCount: 1,  unpaidBalance: 145_000,   askingPrice: 38_000,    location: 'Newark, NJ',      state: 'NJ', zip: '07102', avgDelinquency: 18, performanceStatus: 'Non-Performing', ndaRequired: false, status: 'ACTIVE' },

  // ── Commercial ────────────────────────────────────────────────────────
  { n: 15, sellerIdx: 0, title: 'Midwest Small-Balance Commercial NPL — Mixed Use',   assetType: 'COMMERCIAL',  lienPosition: 'SENIOR', loanCount: 3,  unpaidBalance: 4_250_000, askingPrice: 2_650_000, location: 'Chicago, IL',     state: 'IL', zip: '60601', avgDelinquency:  7, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 16, sellerIdx: 2, title: 'Houston Retail Strip Center Note',                   assetType: 'COMMERCIAL',  lienPosition: 'SENIOR', loanCount: 1,  unpaidBalance: 1_840_000, askingPrice: 1_150_000, location: 'Houston, TX',     state: 'TX', zip: '77019', avgDelinquency:  6, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },
  { n: 17, sellerIdx: 1, title: 'Northeast Office Park NPL',                          assetType: 'COMMERCIAL',  lienPosition: 'SENIOR', loanCount: 1,  unpaidBalance: 6_750_000, askingPrice: 3_800_000, location: 'Philadelphia, PA', state: 'PA', zip: '19103', avgDelinquency: 10, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },

  // ── Consumer ──────────────────────────────────────────────────────────
  { n: 18, sellerIdx: 6, title: 'Unsecured Consumer Charge-Off Tape — Series 26-A',   assetType: 'CONSUMER',    lienPosition: null,     loanCount: 1842, unpaidBalance: 8_950_000, askingPrice: 295_000,   location: 'Nationwide',      state: null,  zip: null,    avgDelinquency: 24, performanceStatus: 'Charged-Off',    ndaRequired: true,  status: 'ACTIVE' },
  { n: 19, sellerIdx: 0, title: 'Auto Deficiency NPL Pool — 124 Accounts',            assetType: 'CONSUMER',    lienPosition: null,     loanCount: 124,  unpaidBalance: 1_120_000, askingPrice: 84_000,    location: 'Nationwide',      state: null,  zip: null,    avgDelinquency: 18, performanceStatus: 'Charged-Off',    ndaRequired: false, status: 'ACTIVE' },

  // ── Mixed / Large institutional ───────────────────────────────────────
  { n: 20, sellerIdx: 1, title: 'Q2 2026 Mixed-Asset Strategic Disposition (42 Loans)', assetType: 'MIXED',    lienPosition: 'SENIOR', loanCount: 42, unpaidBalance: 12_400_000, askingPrice: 7_800_000, location: 'Multi-State',     state: 'CA', zip: '90001', avgDelinquency:  8, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'ACTIVE' },

  // ── A couple closing / sold to make pipeline real ─────────────────────
  { n: 21, sellerIdx: 2, title: 'Orlando FL Residential Note — UNDER LOI',            assetType: 'RESIDENTIAL', lienPosition: 'SENIOR', loanCount: 1,  unpaidBalance: 285_000,   askingPrice: 185_000,   location: 'Orlando, FL',     state: 'FL', zip: '32801', avgDelinquency:  5, performanceStatus: 'Non-Performing', ndaRequired: true,  status: 'DUE_DILIGENCE' },
