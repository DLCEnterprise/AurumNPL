...
- Name: auth-signin.spec.ts >> Sign in >> rejects invalid credentials with error UI
- Location: tests\simulations\workflows\auth-signin.spec.ts:18:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e4]:
    ...
    - alert [ref=e10]: Incorrect email or password. Please try again.
    - generic [ref=e11]:
      - generic [ref=e12]:
        - generic [ref=e13]: Email Address
        - textbox "Email Address" [ref=e14]:
          - /placeholder: you@company.com
          - text: r.calloway@northchase-nh.com
      - generic [ref=e15]:
        - generic [ref=e16]: Password
        - textbox "Password" [ref=e17]:
          - /placeholder: ••••••••
          - text: wrong-password-deliberately
      - link "Forgot password?" [ref=e19] [cursor=pointer]:
        - /url: /forgot-password
      - button "Sign In" [ref=e20] [cursor=pointer]
    - generic [ref=e21]: New to AURUM?
