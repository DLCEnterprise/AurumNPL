...
- Name: auth-signin.spec.ts >> Sign in >> renders sign-in page cleanly
- Location: tests\simulations\workflows\auth-signin.spec.ts:7:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e20]: New to AURUM?
    - link "Request Access" [ref=e21] [cursor=pointer]:
      - /url: /signup
  - region
  - alert [ref=e22]
```
