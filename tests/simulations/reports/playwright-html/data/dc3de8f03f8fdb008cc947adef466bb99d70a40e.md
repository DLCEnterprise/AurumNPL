...
- Name: auth-forgot-password.spec.ts >> Forgot password >> submits unknown email without leaking existence (privacy)
- Location: tests\simulations\workflows\auth-forgot-password.spec.ts:16:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e4]:
    ...
    - alert [ref=e10]: If that email is registered, a reset link has been sent. Check your inbox.
    - generic [ref=e11]: Remember your password?
    - link "Back to Sign In" [ref=e12] [cursor=pointer]:
      - /url: /signin
  - region
  - alert [ref=e13]
```
